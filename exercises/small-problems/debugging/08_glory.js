...
function toss(...args) {
  // This line needs a function as an argument
...
function targetRoll(
  ...
  // The problem is here with this switch statement
  switch (result) {
    case 1:
      automaticFail()
      break
...
// The problem is with the switch statement. We need to insert break statements
// to make sure it doesn't fall through all the cases
