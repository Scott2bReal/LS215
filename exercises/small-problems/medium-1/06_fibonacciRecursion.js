...
// 1. The third number is 1 + 1 = 2, the fourth is 1 + 2 = 3, the fifth is 2 +
// 3 = 5, and so on. In mathematical terms, this can be represented as:
...
// discouraged if you are not able to solve it on your own; recursion is
